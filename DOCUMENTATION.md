...
Aside from these opportunities for specific contribution, a more general field of interest is the extension of the proposed system to an actual application scenario in the clinical setting on sensible data for which the capacity to run locally and not share information is crucial such as patient data and hospital documentation.
